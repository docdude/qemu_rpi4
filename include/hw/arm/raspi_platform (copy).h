...
#define MSYNC_OFFSET            0x2000000   /* Multicore Sync Block */
#define IC0_OFFSET              0x2002000
#define ST_OFFSET               0x2003000   /* System Timer */
#define MPHI_OFFSET             0x2006000   /* Message-based Parallel Host Intf. */
#define DMA_OFFSET              0x2007000   /* DMA controller, channels 0-14 */
#define BRDG_OFFSET             0x200a000
#define ARM_OFFSET              0x200B000   /* BCM2708 ARM control block */
#define ARMCTRL_OFFSET          (ARM_OFFSET + 0x000)
#define ARMCTRL_IC_OFFSET       (ARM_OFFSET + 0x200) /* Interrupt controller */
#define ARMCTRL_TIMER0_1_OFFSET (ARM_OFFSET + 0x400) /* Timer 0 and 1 */
#define ARMCTRL_0_SBM_OFFSET    (ARM_OFFSET + 0x800) /* User 0 (ARM) Semaphores
                                                      * Doorbells & Mailboxes */
#define CPRMAN_OFFSET           0x2100000 /* Power Management, Watchdog */
#define CM_OFFSET               0x2101000 /* Clock Management */
#define A2W_OFFSET              0x2102000 /* Reset controller */
#define AVS_OFFSET              0x2103000 /* Audio Video Standard */
#define RNG_OFFSET              0x2104000
#define GPIO_OFFSET             0x2200000
#define UART0_OFFSET            0x2201000
#define MMCI0_OFFSET            0x2202000
#define I2S_OFFSET              0x2203000
#define SPI0_OFFSET             0x2204000
#define BSC0_OFFSET             0x2205000 /* BSC0 I2C/TWI */
#define OTP_OFFSET              0x220f000
#define THERMAL_OFFSET          0x15d2200
#define GENET_OFFSET		 0x1580000
#define MII_OFFSET		 0x1580e14
//#define THERMAL_OFFSET          0x212000
#define BSC_SL_OFFSET           0x2214000 /* SPI slave */
#define AUX_OFFSET              0x2215000 /* AUX: UART1/SPI1/SPI2 */
#define EMMC1_OFFSET            0x2300000
#define EMMC2_OFFSET            0x2340000
#define SMI_OFFSET              0x2600000
#define BSC1_OFFSET             0x2804000 /* BSC1 I2C/TWI */
#define BSC2_OFFSET             0x2805000 /* BSC2 I2C/TWI */
#define DBUS_OFFSET             0x2900000
#define AVE0_OFFSET             0x2910000
#define USB_OTG_OFFSET          0x2980000 /* DTC_OTG USB controller */
#define SDRAMC_OFFSET           0x2e00000
#define DMA15_OFFSET            0x2E05000 /* DMA controller, channel 15 */
...
#define INTERRUPT_THERMAL              73
#define INTERRUPT_GENET_157            93
#define INTERRUPT_GENET_158            94
...
#define BCM2835_VC_PERI_BASE 0x7c000000
